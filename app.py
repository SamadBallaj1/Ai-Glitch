...
if submit:
    ...
    is_valid_guess, guess_number, error_message = parse_guess(raw_guess)

    if not is_valid_guess:
        st.session_state.history.append(raw_guess)
        st.error(error_message)
    else:
        st.session_state.history.append(guess_number)
        outcome, message = check_guess(guess_number, st.session_state.secret)
